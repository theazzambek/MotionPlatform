...
# SECRET_KEY = "django-insecure-$g*nkm)rbf5=1*6gw#pgn%i2j=p6vc_+t4i@a^kfbz1-98fj1)"

DEBUG = config('DEBUG', default=False, cast=bool)
# DEBUG = True

ALLOWED_HOSTS = ['*']
# ALLOWED_HOSTS = ['gulmira2005.pythonanywhere.com', '127.0.0.1']

MY_APPS = ["apps.users", "apps.main_page", "apps.userprofile"]
...
#         # default="postgres://usermotionweb:passmotionweb@localhost:5432/basamotionweb"
#     )
# }
